...
class OrderResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        $res = [
            ...
            'client_tariff_additional_hour_price' => $this->client_tariff_additional_hour_price,
            'client_tariff_additional_point_price' => $this->client_tariff_additional_point_price,
            'client_tariff_loading_points' => $this->client_tariff_loading_points,
            'client_tariff_unloading_points' => $this->client_tariff_unloading_points,
            ...
            'carrier_tariff_additional_hour_price' => $is_resident ? $this->client_tariff_additional_hour_price : $this->carrier_tariff_additional_hour_price,
            'carrier_tariff_additional_point_price' => $is_resident ? $this->client_tariff_additional_point_price : $this->carrier_tariff_additional_point_price,
            'carrier_tariff_loading_points' => $is_resident ? $this->client_tariff_loading_points : $this->carrier_tariff_loading_points,
            'carrier_tariff_unloading_points' => $is_resident ? $this->client_tariff_unloading_points : $this->carrier_tariff_unloading_points,
